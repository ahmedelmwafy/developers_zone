          ...
          child: Column(
            children: [
                ...
                trailing: Switch(
                  ...
                  onChanged: (val) {
                    chatController.muteChat(
                        auth.currentUser!.uid, widget.chatId,
                        mute: val);
                  },
              ...
              _buildOptionTile(
                ...
                label:
                    AppLocalization.of(context)!.translate('purge_local_repo'),
                subLabel: AppLocalization.of(context)!
                    .translate('destructive_action'),
                onTap: () {
    ...
    return Column(
      children: [
        AppCachedImage(
          ...
          errorWidget:
              const Icon(Icons.person, color: Colors.white10, size: 60),
        ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(icon,
                color: color ?? Colors.white.withValues(alpha: 0.6), size: 24),
